...
javac --module-path mods -d cli/target cli/lando/mel/cli/creators/**.java 
...
javac --module-path mods -d app/target app/lando/mel/app/animals/*.java app/lando/mel/app/helpers/AnimalFactory.java 
    app/lando/mel/app/database/ConnectionHandler.java  app/lando/mel/app/Main.java app/module-info.java
