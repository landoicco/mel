...
public class Cat extends Animal {
    ...
    public Cat(int id, String name, String gender, String birthDate, boolean alive, String breed, String eyeColor,
            Set<String> colors, Set<String> pathologies, Object vaccineRecord) {
